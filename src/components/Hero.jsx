  ...
  return (
    <section className="min-h-[80vh] flex flex-col justify-center pt-20">
      ...
      <h1 className="text-4xl md:text-6xl font-bold text-slate-100 mb-6 leading-tight">
        It’s more than <span className="text-emerald-400">syntax.</span><br className="hidden md:block"/>
      ...
      <div className="flex gap-4 font-mono text-sm">
        <a href="#projects" className="px-6 py-3 bg-emerald-500 text-slate-900 font-bold rounded hover:bg-emerald-400 transition-colors flex items-center gap-2">
          Lihat Arsitektur <ChevronRight size={16} />
        </a>
        <a href="#contact" className="px-6 py-3 border border-slate-700 text-slate-300 rounded hover:bg-slate-800 transition-colors flex items-center gap-2">
